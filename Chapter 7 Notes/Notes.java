...
public class Notes
{
    ...
    {
        /*
         * An array is ordered collection of elements of the same
         *      type. The type can be a primitive (e.g., int) or
         *      a class (e.g., Turtle).
         *      
         *  An array is like an object in that it must be declared
         *      and initialized.
         *      
         *  The number is the square brackets specifies the number of
    ...
    public static void createArrayOfOdds()
    {
         ...
         *  The local variable (e.g., number) contains a copy of
