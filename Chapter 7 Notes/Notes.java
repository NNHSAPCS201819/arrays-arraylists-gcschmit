...
public class Notes
{
    ...
    {
        /*
         * An array is an ordered collection of elements of the
         *      same type. The type can be a primitive (e.g., int)
         *      or a class (e.g., Turtle).
         *  
         *  An array variable is like an object variable in that
         *      it must be declared and initialized.
         *      
         *  The number in the square brackets specifies the number
         *      of elements in the array.
         *      
         *  All elements in the array are initialized to their
         *      default values (e.g., 0, false, null).
         *      
         *  This is an example that creates an array that contains
         *      10 int values.
         */
    ...
    public static void createArrayOfOdds()
    {
         ...
         *      when the array is declared. The size of the array
         *      is inferred based on the number of elements in the
         *      literal.
         */
         ...
         * Array References
         * 
         *  Variables of type array, contain a reference to the
         *      array stored in the computer's memory.
         *      
         *  Assigning one array variable's value to another,
         ...
         * 
         *  The local variable (e.g., element) contains a copy of
    ...
    public static void createArrayOfCalendars()
    {
         ...
         *      initialized to null. We have to explicilty create
         *      new objects and assign to each element.
         */
        GregorianCalendar[] calendars = new GregorianCalendar[12];
        
        /*
         * At this point, every element in the array has a value 
         *      of null.
         */
        ...
        /*
         * Create a new calendar object and assign it to each
        ...
        /*
         * An enhanced for loop cannot modify the values of the
