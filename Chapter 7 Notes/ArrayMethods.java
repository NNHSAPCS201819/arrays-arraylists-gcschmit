...
public class ArrayMethods
{
    ...
    public static void main( String[] args )
    {
        ...
        System.out.print( "Get Second Largest: ");
        System.out.println( tester.getSecondLargest());
        
        System.out.print( "Is Sorted Increasing: ");
        System.out.println( tester.isSortedIncreasing());
        
        int[] testValues2 = { 3, 5, 6, 8, 11, 15, 22, 37, 37, 47 };
        ...
        System.out.println( tester );
        System.out.print( "Has Duplicate Adjacent Elements: ");
        System.out.println( tester.hasDuplicateAdjacentElements());
        
        int[] testValues3 = { 3, 5, 6, 8, 10, 11, 22, 37, 38, 47 };
        ...
        System.out.println( tester );
        System.out.print( "Has Duplicate Elements: ");
        System.out.println( tester.hasDuplicateElements());
        
        int[] testValues4 = { 3, 11, 6, 8, 10, 11, 22, 37, 37, 47 };
